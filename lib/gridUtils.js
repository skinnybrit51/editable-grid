...
module.exports = function (options) {
    ...
    var utils = {
        ...
        _deleteRow: function (rowId) {
            grid.ears.trigger('booty-can-delete', rowId).done(function () {
                // can delete
        ...
        _treeNodeExpand: function (rowId) {
            grid.ears.trigger('booty-before-tree-node-expand', rowId);
            ...
            dfd.done(function () {
                ...
                grid.render();
                grid.ears.trigger('booty-after-tree-node-expand', rowId);
            });
        },

        _treeNodeCollapse: function (rowId) {
            grid.ears.trigger('booty-before-tree-node-collapse', rowId);
            grid._treeState[rowId] = 'collapse';

            grid.render();
            grid.ears.trigger('booty-after-tree-node-collapse', rowId);
        }
    };
    return utils;
