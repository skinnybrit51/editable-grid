...
var cellFactory = {
    ...
    createSelect: function (column, value) {
        // opening tag
        var cell = '<td data-col-id="' + column.id + '" style="width:' + column.width + '">';
    ...
    createTableData: function (options) {
        ...
        var markup = '<td data-col-id="' + column.id + '" style="width:' + column.width + '">';
    ...
    createTableFooterAddRow: function (options) {
        ...
        _.each(columns, function (column) {
            ...
            if (column.link == null) {
                ...
                row += '<td data-col-id="' + column.id +
                    '" style="width:' + column.width + '"></td>';
            }
        });
